...
# Building archetypes 
#BUILDING_IDS = [
#    "ep_SFH_age_0_climate_0_1241","ep_SFH_age_0_climate_0_649", "ep_SFH_age_0_climate_0_821",
...
BUILDING_IDS = ["ep_SFH_age_0_climate_4_1688", "ep_SFH_age_0_climate_4_1709",
...
"""
, "ep_SFH_age_1_climate_1_429", "ep_SFH_age_1_climate_1_458",
    ...
    try:
        ...
        for day_idx in range(total_days):
            ...
            if os.path.exists(ub_file) and os.path.exists(lb_file):
                ...
                bounds_dict = extract_daily_building_bounds(ub, lb, env, save_dir=None)
