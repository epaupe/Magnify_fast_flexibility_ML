...
# =====================================================
# MAIN PIPELINE (DAILY EXECUTION + TIMING)
# =====================================================
        ...
        for climate_id in CLIMATE_IDS:
            ...
            try:
                ...
                for day_idx in range(total_days):
                    ...
                    print(f"\n---- Day {day_idx + 1}/{total_days}: {day_start.date()} ----")
